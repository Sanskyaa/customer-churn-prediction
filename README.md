...
🔗 **Hosted Project:**
https://sanskar-customer-churn-prediction.streamlit.app/

🔗 **GitHub Repository:**
https://github.com/Sanskyaa/customer-churn-prediction
...
* Modular project structure with separate notebooks, data, models, and application files
...
```bash
git clone https://github.com/Sanskyaa/customer-churn-prediction.git
```
...
* **GitHub:** https://github.com/Sanskyaa/
* **LinkedIn:** https://www.linkedin.com/in/sanskarwaskar/
* **Project Repository:** https://github.com/Sanskyaa/customer-churn-prediction
* **Live Project:** https://sanskar-customer-churn-prediction.streamlit.app/

---

## ⭐ If You Found This Project Useful

Feel free to explore the repository, try the live application, and give the project a ⭐ on GitHub.
